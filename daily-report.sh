...
<title>Boundex Repo Intelligence</title>
<style>
:root{--ink:#171a1f;--muted:#667085;--line:#e3e7ee;--paper:#fafbfc;--panel:#ffffff;--lane:#f4f6f8;--accent:#0f766e;--good:#16834a;--blue:#3b5bdb;--quiet:#98a2b3;--shadow:0 8px 22px rgba(23,26,31,.055)}
...
a{color:var(--accent);text-decoration:none;border-bottom:1px solid rgba(15,118,110,.26)}a:hover{border-bottom-color:var(--accent)}
main{max-width:1440px;margin:0 auto;padding:34px 24px 60px}
.page-header{display:flex;justify-content:space-between;gap:24px;align-items:flex-end;margin-bottom:20px;padding:18px 0 18px;border-bottom:1px solid var(--line)}
h1{margin:0;font-size:35px;line-height:1.04;letter-spacing:0;font-weight:760}.meta{color:var(--muted);font-size:13px;white-space:nowrap}
.topbar{margin-bottom:22px}
.summary{background:var(--panel);border:1px solid var(--line);border-left:4px solid var(--accent);border-radius:8px;padding:22px 24px;box-shadow:var(--shadow)}.summary h2,.board-title{font-size:12px;text-transform:uppercase;letter-spacing:.1em;color:var(--muted);margin:0 0 10px;font-weight:800}.summary p{margin:0;font-size:15px;max-width:110ch}
...
.lane{background:var(--lane);border:1px solid var(--line);border-radius:8px;padding:14px;min-height:380px}.lane header{display:flex;align-items:center;justify-content:space-between;margin:0 0 14px;padding-bottom:10px;border-bottom:1px solid #dde3ea}.lane h2{margin:0;font-size:16px}.lane-count{color:var(--muted);font-size:12px;font-weight:700}
.repo-card{background:var(--panel);border:1px solid var(--line);border-radius:8px;padding:15px;margin-bottom:12px;box-shadow:0 5px 14px rgba(23,26,31,.055);transition:transform .15s ease,box-shadow .15s ease}.repo-card:hover{transform:translateY(-1px);box-shadow:0 10px 20px rgba(23,26,31,.09)}.repo-card.completed{border-top:4px solid var(--good)}.repo-card.active{border-top:4px solid var(--blue)}.repo-card.quiet{border-top:4px solid var(--quiet)}
.card-top{display:flex;justify-content:space-between;gap:12px;align-items:flex-start}.repo-name{font-weight:800;color:var(--ink);border-bottom:0}.repo-subtitle{color:var(--muted);font-size:12px;margin-top:2px}.badge{border-radius:999px;background:#f1f3f6;color:var(--muted);font-size:11px;font-weight:800;padding:4px 9px;white-space:nowrap}.completed .badge{background:#e8f7ee;color:var(--good)}.active .badge{background:#edf1ff;color:var(--blue)}
.count-row{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin:15px 0}.count-row span{background:#fafbfc;border:1px solid #e8edf3;border-radius:7px;padding:8px;font-size:12px;color:var(--muted)}.count-row b{display:block;color:var(--ink);font-size:19px;line-height:1.05}
.card-actions{display:flex;gap:8px;margin-bottom:10px}.card-actions a{background:#fafbfc;border:1px solid #e1e7ef;border-radius:7px;padding:6px 10px;font-size:12px;font-weight:750;color:var(--ink)}
details{border-top:1px solid var(--line);padding-top:9px}summary{cursor:pointer;color:var(--muted);font-size:13px;font-weight:700}h3{font-size:11px;margin:12px 0 6px;color:var(--muted);text-transform:uppercase;letter-spacing:.07em}ul{margin:0;padding-left:18px}li{margin:5px 0;font-size:13px;overflow-wrap:anywhere}li span{color:var(--muted)}.muted{color:var(--muted)}.empty-lane{border:1px dashed #cbd3dd;border-radius:8px;color:var(--muted);padding:18px;text-align:center;background:rgba(255,255,255,.58);font-size:13px;font-weight:700}
