...
<title>Boundex Repo Intelligence</title>
<style>
:root{--primary:#1a73e8;--primary-dark:#1558b0;--on-primary:#fff;--surface:#fff;--surface-variant:#f1f3f4;--background:#f8fafd;--outline:#dadce0;--outline-soft:#e8eaed;--text:#202124;--muted:#5f6368;--success:#188038;--progress:#1a73e8;--quiet:#9aa0a6;--warning:#f9ab00;--shadow-1:0 1px 2px rgba(60,64,67,.3),0 1px 3px 1px rgba(60,64,67,.15);--shadow-2:0 2px 6px rgba(60,64,67,.22),0 1px 2px rgba(60,64,67,.14)}
...
.page-header{display:flex;justify-content:space-between;gap:24px;align-items:center;margin-bottom:22px;padding:18px 20px;background:var(--surface);border:1px solid var(--outline-soft);border-radius:8px;box-shadow:var(--shadow-1)}
h1{margin:0;font-size:30px;line-height:1.1;letter-spacing:0;font-weight:500}.meta{color:var(--muted);font-size:13px;white-space:nowrap}
...
.card-top{display:flex;justify-content:space-between;gap:12px;align-items:flex-start}.repo-name{font-weight:500;color:var(--text);font-size:15px}.repo-subtitle{color:var(--muted);font-size:12px;margin-top:2px}.badge{border-radius:999px;background:#eef0f2;color:var(--muted);font-size:11px;font-weight:500;padding:4px 10px;white-space:nowrap}.completed .badge{background:#e6f4ea;color:var(--success)}.active .badge{background:#e8f0fe;color:var(--progress)}
...
.card-actions{display:flex;gap:8px;margin-bottom:10px}.card-actions a{background:#e8f0fe;border:1px solid #d2e3fc;border-radius:999px;padding:6px 12px;font-size:12px;font-weight:500;color:var(--primary)}
...
@media(max-width:860px){main{padding:18px 12px 44px}.page-header{display:block;padding:16px}h1{font-size:26px}.meta{display:inline-block;margin-top:10px;white-space:normal}.summary{padding:18px}.board{grid-template-columns:1fr;min-width:0}.board-wrap{overflow-x:visible}}
</style>
</head>
<body>
<main>
