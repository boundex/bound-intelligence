...
<title>Boundex Repo Intelligence</title>
<style>
:root{--ink:#2b2422;--muted:#766b67;--line:#ded2ca;--paper:#f8f3ef;--panel:#fffdfb;--lane:#efe7e1;--accent:#a24942;--good:#0f7b58;--blue:#3b6795;--quiet:#a19690;--shadow:0 8px 22px rgba(72,53,52,.07)}
...
a{color:var(--accent);text-decoration:none;border-bottom:1px solid rgba(162,73,66,.28)}a:hover{border-bottom-color:var(--accent)}
...
.lane{background:var(--lane);border:1px solid var(--line);border-radius:8px;padding:14px;min-height:380px}.lane header{display:flex;align-items:center;justify-content:space-between;margin:0 0 14px;padding-bottom:10px;border-bottom:1px solid #dccfc6}.lane h2{margin:0;font-size:16px}.lane-count{color:var(--muted);font-size:12px;font-weight:700}
.repo-card{background:var(--panel);border:1px solid var(--line);border-radius:8px;padding:15px;margin-bottom:12px;box-shadow:0 5px 14px rgba(72,53,52,.055);transition:transform .15s ease,box-shadow .15s ease}.repo-card:hover{transform:translateY(-1px);box-shadow:0 10px 20px rgba(72,53,52,.09)}.repo-card.completed{border-top:4px solid var(--good)}.repo-card.active{border-top:4px solid var(--blue)}.repo-card.quiet{border-top:4px solid var(--quiet)}
.card-top{display:flex;justify-content:space-between;gap:12px;align-items:flex-start}.repo-name{font-weight:800;color:var(--ink);border-bottom:0}.repo-subtitle{color:var(--muted);font-size:12px;margin-top:2px}.badge{border-radius:999px;background:#f2ece8;color:var(--muted);font-size:11px;font-weight:800;padding:4px 9px;white-space:nowrap}.completed .badge{background:#e3f3ec;color:var(--good)}.active .badge{background:#e7edf5;color:var(--blue)}
.count-row{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin:15px 0}.count-row span{background:#fbf7f3;border:1px solid #e8ddd4;border-radius:7px;padding:8px;font-size:12px;color:var(--muted)}.count-row b{display:block;color:var(--ink);font-size:19px;line-height:1.05}
.card-actions{display:flex;gap:8px;margin-bottom:10px}.card-actions a{background:#fbf7f3;border:1px solid #e5d8cf;border-radius:7px;padding:6px 10px;font-size:12px;font-weight:750;color:var(--ink)}
details{border-top:1px solid var(--line);padding-top:9px}summary{cursor:pointer;color:var(--muted);font-size:13px;font-weight:700}h3{font-size:11px;margin:12px 0 6px;color:var(--muted);text-transform:uppercase;letter-spacing:.07em}ul{margin:0;padding-left:18px}li{margin:5px 0;font-size:13px;overflow-wrap:anywhere}li span{color:var(--muted)}.muted{color:var(--muted)}.empty-lane{border:1px dashed #cfc0b7;border-radius:8px;color:var(--muted);padding:18px;text-align:center;background:rgba(255,255,255,.48);font-size:13px;font-weight:700}
